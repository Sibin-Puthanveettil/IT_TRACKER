...
namespace ITTacker
{
    public partial class AdminNoteChanges : System.Web.UI.Page
    {
        ...
        {
            AdminNoteChanges f = new AdminNoteChanges();
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        foreach (DataColumn dc in ds.Tables[0].Columns)
                        {
                            ...
                            {
                                fileByt = (byte[])(dr[dc]);
                                AdminNoteChanges d = new AdminNoteChanges();
                            ...
                            {                                
                                ...
                                if(NextReviewrsId!="0")
                                {
                                    ...
                                    if (apprvType == "L")
                                    {
                                        ...
                                        //    mail.Subject = "Paperless Note -: " + noteid + " - "+ apprvStatus;
                                        //    string imageUrlLog = GetImageUrl("files/img/manappuram_logo.png");
                                        //    string imageContentLog = "<img src='" + imageUrlLog + "' alt='Alternate Text' />";
