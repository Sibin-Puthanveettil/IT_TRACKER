<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="TestCaseVerificationMainReport.aspx.cs" Inherits="ITTracker.TestCaseVerificationMainReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
         <link href="StyleAutoComplete.css" rel="stylesheet" />
    <script src="AutoCompleteJS.js"></script>
    <%--<script src="js/TestCaseVerificationReport.js"></script>--%>
    <script src="js/TestCaseVerificationReport.js"></script>
    <style>
    ...
    <form id="Form1" class="form-horizontal" runat="server" method="post" enctype="multipart/form-data" action="#" style="padding-top:10px;">
        ...
        <div class="row ">
            ...
            <div class="ma-header">
                ...
                <h4 style="align-items: center; align-content: center">TEST CASE VERIFICATION REPORT</h4>
        ...
        <div class=" card-body">
            ...
            <div class="row col-sm-12" style="padding-bottom:20px">
                  <div class="form-group col-sm-2" style="padding-left: 0;">
                    ...
                    <input type="text" id="txt_fromdate" class="form-control" style="width: 100%" readonly="readonly" onmousedown="getDate();" />
                </div>
                <div class="form-group col-sm-2" style="padding-left: 0;">
                    <label>To Date <span class="required text-danger">*</span> </label>
                    <input type="text" id="txt_Todate" class="form-control" style="width: 100%" readonly="readonly" onmousedown="getDate();" />
                </div>
            ...
            <div class="row col-sm-12" style="padding-bottom:20px">
                ...
                <div class=" form-group col-md-12 row  padding-bottom-10px p-2">
                        ...
                        <div class="col-md-2 ">
                            <input id="btnConfirm" type="button" value="Generate" class="btn btn-block btn-outline-primary btn-sm" onclick="viewPostReleaseReport()" data-toggle="modal" data-backdrop="false" />
