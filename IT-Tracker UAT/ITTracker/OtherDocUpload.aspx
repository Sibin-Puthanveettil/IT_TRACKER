<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="OtherDocUpload.aspx.cs" Inherits="ITTracker.OtherDocUpload" %>
                            ...
                            if (fileReader && fileList && fileList.length) {
                                ...
                                fileReader.onload = function () {
                                    ...
                                    $.ajax({
                                        ...
                                        url: "OtherDocUpload.aspx/UploadingFile",
    ...
    if (querystring == '0' || querystring == '' || querystring == 'undefined' || querystring == null) {
        ...
        function File_Load() {               
            ...
            $.ajax({
                type: "post",
                contentType: "application/json; charset=utf-8",
                url: "OtherDocUpload.aspx/getFileData",
                async: false,
                data: "{pageVal:'GetOtherDoc', pageval1 :'" + noteid+ "', pageval2 :'" + filenm + "'}",
                dataType: "json",
                success: function (Result) {
                    Result = Result.d;
            ...
            Swal.fire({
                    ...
                    if (result.value == true) {
                        ...
                        $.ajax({
                                type: "post",
                                contentType: "application/json; charset=utf-8",
                                url: "OtherDocUpload.aspx/DeleteFileInDB",
                                ...
                                success: function (Result) {
                                                    ...
                                                    if (Result!="") {
                                                        ...
                                                        window.location.href = "OtherDocUpload.aspx?noteid=" + note + "=" + reqid + "="+ module;
                                                        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="card card-5 rightmarg">
        <form class="form-inline" runat="server" method="post" enctype="multipart/form-data">
            <div class="card-body">
                <h2> Attach Other Documents/Approvals</h2>
