<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="TestReportMain.aspx.cs" Inherits="ITTracker.TestReportMain" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <link href="StyleAutoComplete.css" rel="stylesheet" />
    <script src="AutoCompleteJS.js"></script>
    <script src="js/TestReport.js"></script>
    <style>
    ...
    <form id="Form1" class="form-horizontal" runat="server" method="post" enctype="multipart/form-data" action="#" style="padding-top:10px;">
        ...
        <div class="row ">
            ...
            <div class="ma-header">
                ...
                <h4 style="align-items: center; align-content: center">QA TRACKING REPORT</h4>
        ...
        <div class=" card-body">
            ...
            <div class="row col-sm-12" style="padding-bottom:20px">
                  <div class="form-group col-sm-2" style="padding-left: 0;">
                    ...
                    <input type="text" id="txt_TstStsDate" class="form-control" style="width: 100%" readonly="readonly" onmousedown="getDate();" />
                </div>
                <div class="form-group col-sm-2" style="padding-left: 0;">
                    <label>Initial From Date <span class="required text-danger">*</span> </label>
                    <input type="text" id="txt_TASrtDate" class="form-control" style="width: 100%" readonly="readonly" onmousedown="getDate();" />
                </div>
                <div class="form-group col-sm-2" style="padding-left: 0;">
                    <label>Initial To Date <span class="required text-danger">*</span> </label>
                    <input type="text" id="txt_TarDate" class="form-control" style="width: 100%" readonly="readonly" onmousedown="getDate();" />
                </div>
                </div>
            ...
            <div class="form-group col-md-3" style="padding-left: 0;">
                    <label>QA Tech lead </label>
                    <select class="form-control select2" style="width: 100%" id="ddlTLead">
                    </select>
                </div>

                <div class="form-group col-md-4" style="padding-left: 0;">
                    <label>Tester</label>
                    <select class="form-control select2" style="width: 100%" id="ddlTester">
                    </select>
                </div>
