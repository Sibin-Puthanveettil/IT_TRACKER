<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="ChangeDocUpload.aspx.cs" Inherits="ITTracker.ChangeDocUpload" %>
    ...
    <script>
                            ...
                            if (fileReader && fileList && fileList.length) {
                                ...
                                fileReader.onload = function () {
                                    ...
                                    $.ajax({
                                        ...
                                        url: "ChangeDocUpload.aspx/UploadingFile",
        ...
        function Change_DocUpload() {
            ...
            if (querystring == '0' || querystring == '' || querystring == 'undefined' || querystring == null) {
                ...
                module_id=querystring.split("=")[3];
                window.location.href = "Documentation_upload.aspx?noteid=" + note + "=" + reqid + "=" + module_id
            }
        ...
        function File_Load() {
            ...
            $.ajax({
                type: "post",
                contentType: "application/json; charset=utf-8",
                url: "ChangeDocUpload.aspx/getFileData",
                async: false,
                data: "{pageVal:'GetAttachChangeDoc', pageval1 :'" + noteid + "', pageval2 :'" + filenm + "'}",
                dataType: "json",
                success: function (Result) {
                    Result = Result.d;
            ...
            Swal.fire({
                ...
                if (result.value == true) {
                    ...
                    $.ajax({
                        ...
                        async: false,
                        contentType: "application/json; charset=utf-8",
                        url: "ChangeDocUpload.aspx/DeleteFileInDB",
                        ...
                        success: function (Result) {
                                                    ...
                                                    if (Result!="") {
                                                        ...
                                                        window.location.href = "ChangeDocUpload.aspx?noteid=" + note + "=" + reqid + "=" + module;
                                                        }
