<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="TaReport.aspx.cs" Inherits="ITTracker.TaReport" %>
...
<%--  <link href="StyleAutoComplete.css" rel="stylesheet" />
    ...
    <script src="js/Ta%20Report.js"></script>
    ...
    <form id="Form1" class="form-horizontal" runat="server" method="post" enctype="multipart/form-data" action="#" style="padding-top:10px;">
        ...
        <div class="row ">
            ...
            <div class="ma-header">
                ...
                <h4 style="align-items: center; align-content: center">TA TRACKING REPORT</h4>
        ...
        <div class=" card-body">
             ...
             <div class="row col-sm-12" style="padding-bottom:20px">
                <div class="form-group col-md-4" style="padding-left: 0;">
                    ...
                    <select class="form-control select2" style="width: 100%" id="taselect">
                        <option value="-1">--SELECT--</option>
                         <option value="1">DEVELOPMENT TA</option>
                       <option value="2">TESTING TA</option>
                    </select>
                </div>
