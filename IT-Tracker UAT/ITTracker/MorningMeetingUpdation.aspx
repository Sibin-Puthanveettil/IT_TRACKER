<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="MorningMeetingUpdation.aspx.cs" Inherits="ITTracker.MorningMeetingUpdation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="js/MorningMeetingUpdtn.js?<%=DateTime.Now.Ticks.ToString()%>"></script>
      <style>
    ...
    <form id="Form1" class="form-horizontal" runat="server" method="post" enctype="multipart/form-data" action="#" style="padding-top:20px;">
        <section class="panel <%--vh-75 scrollable--%>" id="contentDivID">
            ...
            <div class="ma-header">
                ...
                <h4 style="align-items: center; align-content: center;color: #45457b">MORNING MEETING UPDATION</h4>
             ...
             <label class="col-md-1 align-left " >From Date: </label>
                 ...
                 &nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  <label class="col-md-1 align-left ">To Date: </label>
                  <div class="col-md-3 align-left ">
                    <input type="text" id="txtToDate" class="form-control" style="width: 100%" readonly="readonly" onmousedown="getDate();" />
                </div>
                 </div>
                  <%--  <div class="row" style="padding-left: 150px;">--%>
                     <%-- <label class="col-md-10 align-left " style="padding-left: 450px;padding-top:30px;">Leave Status</label>--%>
               
                      <%--  </div>--%>
                 <div class="row" style="padding-left: 150px;padding-top:30px;">
                     <label class="col-md-1 align-left " >Leave Status</label>&nbsp&nbsp&nbsp
                       <%--<label class="col-md-1 align-left ">Total:</label>--%>
                
                     <input type="text" id="txtleavestatus" placeholder="Total" onkeypress="return onlyNos(event,this);" class="form-control" style="width: 100px;"/> &nbsp&nbsp&nbsp&nbsp&nbsp
                      
               
                    
                     <input type="text" id="txtleavestatus1" placeholder="Present" onkeypress="return onlyNos(event,this);" class="form-control" style="width: 100px;"/>&nbsp&nbsp&nbsp&nbsp&nbsp 

                 
                     
                     <input type="text" id="txtleavestatus2" placeholder="Absent" onkeypress="return onlyNos(event,this);" class="form-control" style="width: 100px;"/> 
                    ...
                    <select class="form-control tlead select2" style="width: 100%"  id="ddlTLead" onchange="countdetails()">
                     ...
                     <div class="col-md-3 align-left ">
                        <a href="#" class="btn btn-sm animated-button thar-one btn-info btn-xs" style="width: 70%; margin: 5px;"
                            onclick="return countdetails();" id="btnview"><i class="fa fa-magnifying-glass"></i>View Report</a>
