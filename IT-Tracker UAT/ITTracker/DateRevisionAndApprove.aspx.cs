...
namespace ITTracker
{
    public partial class DateRevisionAndApprove : System.Web.UI.Page
    {
        ...
        [WebMethod(EnableSession = true)]
        public static string RequestConfirm(string pageVal, string pageval1, string pageval2)
        {
        ...
        public static string UploadingFile(string ImageData, string InputData)
        {
            ...
            string InputDataExt = InputDataDecrypted.Split('µ')[3];
            try
            {
                if (extentions.Contains(InputDataExt))
                {
                    ...
                    result = obj1.TrackerDocumentUpload("33", InputDataDecrypted, imgByte);
                    return result;
                }
                else
                {
