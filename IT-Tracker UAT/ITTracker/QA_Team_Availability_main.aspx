<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="QA_Team_Availability_main.aspx.cs" Inherits="ITTracker.QA_Team_Availability_main" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <link href="StyleAutoComplete.css" rel="stylesheet" />
    <script src="AutoCompleteJS.js"></script>
    <script src="js/Qa_tester_rpt.js"></script>
    <style>
    ...
    <form id="Form1" class="form-horizontal" runat="server" method="post" enctype="multipart/form-data" action="#" style="padding-top:10px;">
        ...
        <div class="row ">
            ...
            <div class="ma-header">
                ...
                <h4 style="align-items: center; align-content: center">QA Team Availability</h4>
