<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="oversightreport_cto_verification.aspx.cs" Inherits="ITTracker.oversightreport_cto_verification" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="js/crfoversight_cto_verification.js"></script>
            ...
            <div class="card-body">
                <div class="card-body shadow" style="background: #fff;">
                    <div class="row col-md-12 col-md-6 col-md-4" style="padding-left: 30%;">
                        <h4><b>CRF OVER SIGHT HEAD VERIFICATION</b></h4>
                    </div>
                    </br></br>
                   ...
                   <div class="row">
                       <div class="col-md-10 text-left font-12" style="margin-left: 107px;">
                      &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <label class="col-md-1 align-left ">CRF:<span class="required text-danger">*</span> </label>
                      <select id="ddlCrf" class="form-control" style="width: 70%;" name="CRF_Sel" onchange="fillCRFData()">
                ...
                <div id="ModeModal" class="modal fade" role="dialog">
                    ...
                    <div class="row" id="cnfrm">
                        ...
                        <div class="card-body shadow" style="background: #fff;">
                          ...
                          <label class="col-md-4 " style="padding-left:70px;">Verified By:</label>

                          <input type="text" class="form-control" style="width: 30%; box-shadow: 0 4px 6px -5px hsl(0, 0%, 40%), inset 0px 4px 6px -5px black"  id="Verifiedby" title="Verifiedby" readonly="readonly" />

                            </div>
                            </br>
                                      <div class="row">

                       <b> <label class="pure-material-textfield-outlined">
                            <textarea rows="2" cols="100" name="Remarks" id="txtRemarks1" maxlength="3500" title="Remarks" oninput="this.value = this.value.replace(/[^-@.,/#&+\w\s]/g, '');" readonly="readonly"></textarea>
                            <span>Verified Remarks</span>
                        </label></b>

                    </div></br>
                            <div class="form-group col-sm-6">
                                <label class="col-md-4 "  style="padding-left:70px;">STATUS:<span class="required text-danger">*</span> </label>

                                <div class="div-select-dark">
                                    <select class="select-dark"  name="status" id="ddlstatus" style="width: 200px;">
                    ...
                    <div class="row" id="showSubmitBtn" style="padding-left: 300px;">
                        <div class="col-md-3 align-left ">
                            <a href="#" class="btn btn-sm animated-button thar-one btn-success" style="width: 100%; margin: 5px;"
                                onclick="return Confirmctoverification();" id="btnSubmit1"><i class="fa fa-thumbs-up"></i>Confirm</a>
