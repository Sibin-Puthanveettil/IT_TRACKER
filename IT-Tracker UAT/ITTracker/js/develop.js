...
function updat() {
    ...
    var dtl;
        ...
        if ($("#wstatus").val() == 2) {
            ...
            if ($("#gitbranch").val() == "") {
                alert("Enter Github Branch Name!!");
                $("#gitbranch").focus();
                return false;
            }
            if ($("#gitres").val() == "") {
                alert("Enter Github Repository Name!!");
                $("#gitres").focus();
                return false;
            }
    ...
    if ($("#mdnames").val() != -1 && $("#uatpath").val() != "" && $("#uatlink").val() != "" && $("#table").val() != "" && $("#ddlproc").val() != -1 && $("#gitbranch").val() != "" && $("#gitres").val() != "") {
        dtl = mdn + '~' + ff + '~' + ul + '~' + $("#uatpath").val() + '~' + gitbranch + '~' + gitrepositary + '^';
        //alert(dtl);
    }
            ...
            if (fileReader && fileList && fileList.length) {
                ...
                fileReader.onload = function () {
                    ...
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "DeveloperUpdation.aspx/UploadingFiles",
