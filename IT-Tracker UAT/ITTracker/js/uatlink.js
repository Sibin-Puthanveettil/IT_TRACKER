...
function getTesteremark(req) {

    $.ajax({
        type: "post",
        contentType: "application/json; charset=utf-8",
        url: "uatlink.aspx/getRequestNoteForLink",
        data: "{pageVal:'Testeremark', pageval1 :'" + req + "', pageval2:''}",
        dataType: "json",
        success: function (Result) {
            alert(Result);
            Result = Result.d;
...
function Returning() {
    ...
    Data = crf + 'µ' + user + 'µ' + rmk + 'µ' + rqid + 'µ15µ';
    ...
    $.ajax({
        type: "post",
        contentType: "application/json; charset=utf-8",
        url: "uatlink.aspx/ReturnCRFUAT",
        data: "{pageVal:'UATRETURN', pageval1:'" + Data + "',pageval2:'" + rmk + "'}",
        dataType: "json",
        success: function (Result) {
            Result = Result.d;
            if (Result != "0") {
