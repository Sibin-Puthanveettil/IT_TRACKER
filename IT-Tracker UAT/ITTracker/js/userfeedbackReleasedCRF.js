...
function CRFLoad() {
    ...
    $.ajax({
        ...
        url: "UserfeedbackReleasedCRF.aspx/getFillData",
        data: "{pageVal:'feedbackReleasecrf', pageval1 :'" + usr + "'}",
        dataType: "json",
...
function PathLoad(CRFID) {
    $.ajax({
        type: "post",
        contentType: "application/json; charset=utf-8",
        url: "UserfeedbackReleasedCRF.aspx/getpath",
...
function detailsLoad(noteid) {
    $.ajax({
        type: "post",
        contentType: "application/json; charset=utf-8",
        url: "UserfeedbackReleasedCRF.aspx/getRequestNote",
...
function filesFill(noteid) {
    ...
    $.ajax({
        type: "post",
        contentType: "application/json; charset=utf-8",
        url: "UserfeedbackReleasedCRF.aspx/getFileData",
        async: false,
...
function ConfirmNote() {
    ...
    $.ajax({
        type: "post",
        contentType: "application/json; charset=utf-8",
        url: "UserfeedbackReleasedCRF.aspx/Confirmdata",
        data: "{pageVal:'USERFEEDBACK', pageval1 :'RELEASECRFFEEDBACK',pageval2:'" + crfid + "',pageval3:'" + remark + "'}",
        dataType: "json",
        async: false,
        success: function (Result) {
            ...
            if (noteid != "0") {
                ...
                Swal.fire({
                    ...
                    onClose: () => {
                        ...
                        window.open('UserfeedbackReleasedCRF.aspx', '_self');
                    }
                }).then((result) => {
                    if (
