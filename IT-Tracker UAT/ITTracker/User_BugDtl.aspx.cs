...
namespace ITTracker
{
    public partial class User_BugDtl : System.Web.UI.Page
    {
        ...
        public static string ConfirmRecommendNote(string pageVal, string pageval1, string pageval2, string pageval3)
        {
            ...
            ITService.ITServiceClient obj1 = new ITService.ITServiceClient();
            ds = obj1.TrackerSelect("USERFEEDBACK", pageVal, pageval1, pageval2, "");
            List<string> ccList = new List<string>();
                ...
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        foreach (DataRow dr in ds.Tables[0].Rows)
                        {
                            ...
                            {
                                IncidentID = dr[0].ToString(),
                                Subject = dr[1].ToString(),
                                RequestID = dr[2].ToString(),
        ...
        public static string FillBugDetails(string pageVal, string pageval1, string pageval2)
        {
            ...
            try
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    str = ds.Tables[0].Rows[0][0].ToString() + "^" + ds.Tables[0].Rows[0][1].ToString() + "^" + ds.Tables[0].Rows[0][2].ToString() + "^" + ds.Tables[0].Rows[0][3].ToString() + "^" + ds.Tables[0].Rows[0][4].ToString() + "^" + ds.Tables[0].Rows[0][5].ToString() + "^" + ds.Tables[0].Rows[0][6].ToString();
