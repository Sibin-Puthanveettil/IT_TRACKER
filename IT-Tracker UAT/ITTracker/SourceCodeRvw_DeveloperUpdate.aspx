<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="SourceCodeRvw_DeveloperUpdate.aspx.cs" Inherits="ITTracker.SourceCodeRvw_DeveloperUpdate" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Srccode_revwupdt.js"></script>
            ...
            <div class="card-body">
                ...
                <div class="row ">
                    <div class="col-md-6" id="attFiles" style="display: none">
                        <h6 class="modal-title" id="lblFiles">Sourcecode Review Document</h6>
                ...
                <div class="col-md-4 float-left">
                    <label>RESOLVE</label>
                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" class="toggle" id="chkaddprdt" onclick="addproductchk();" />
                    <label for="chkaddprdt">
                ...
                <div class="row" id="showSubmitBtn">
                    <div class="col-md-2 col-sm-2 col-xs-4">
                        <a href="#" class="btn btn-sm animated-button thar-one btn-primary" style="width: 100%; margin: 5px;"
                            onclick="return developerUpdatedoc();" id="btnSubmit"><i class="fa fa-thumbs-up"></i>Confirm</a>
                    </div>

                    <div class="col-md-2 col-sm-2 col-xs-4">
                        <a href="#" class="btn btn-sm animated-button thar-one btn-red" style="width: 100%; margin: 5px;"
                            onclick="return frmExit();"><i class="fa fa-sign-out-alt" id="btnReject"></i>Exit</a>
                    </div>
                </div>
