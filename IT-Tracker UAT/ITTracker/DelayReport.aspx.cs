...
namespace ITTracker
{
    public partial class DelayReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ds = obj1.TrackerSelect("GetDelayTrackReport", "GetDelayTrackReport", mnuId, "", "");
        ...
        protected void btn_Excel_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=BugStatusReport.xls");
        ...
        public void Excel_export(DataTable dt)
        {
            ...
            //    Response.AddHeader("content-disposition", "attachment;filename=Cibil_data.xlsx");
