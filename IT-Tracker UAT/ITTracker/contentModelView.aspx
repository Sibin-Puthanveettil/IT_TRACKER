<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="contentModelView.aspx.cs" Inherits="ITTacker.contentModelView" %>
         ...
         <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- /.modal -->
                                <img src="../../assets/images/alert/model2.png" alt="default" data-toggle="modal" data-target=".long-modal" class="model_img img-fluid" />
                            </div>
                        </div>
                    </div>
         <div class="col-md-4">
