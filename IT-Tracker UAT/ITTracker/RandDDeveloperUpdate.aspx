<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="RandDDeveloperUpdate.aspx.cs" Inherits="ITTracker.RandDDeveloperUpdate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="js/RandDWorkUpdate.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card-body">
        <div class="row ">
                ...
                <div class="ma-header">
                    <h4 style="color: #45457b; align-items: center; align-content: center">R&D Work Update</h4>
                </div>
            </div>
        <hr />
        ...
        <div class="row" id="to_cancell">
            ...
            <div class="col-md-10 align-left">
                <select id="ddlCrf" class="form-control" style="width: 100%;" name="CRF_Sel" onchange="return detailsLoad();">
        ...
        <div class="row">
            <label class="col-md-2 align-left ">Choose Status<span class="required">* :</span> </label>
            <div class="col-md-4 align-left">
                <select id="ddlStatus" class="form-control" style="width: 100%;" name="ddlStatus" onchange="updationcheck()">
                </select>
            </div>
         ...
         <br />
            ...
            <div class="col-md-12" id="parallelrow">
                   <div class="form-group">
                       <label for="rdbNature">Document Uploads </label>
                       <div class="file-upload">
                           <div class="file-select col-md-6 align-right" >
        ...
        <div class="row" id="showSubmitBtn">
            <div class="col-md-2 col-sm-2 col-xs-4">
                <a href="#" class="btn btn-block btn-outline-success btn-flat" style="width: 100%; margin: 5px;"
                    onclick="return WorkCreateConfirm();" id="btnSubmit"><i class="fa fa-thumbs-up"></i>&nbsp;Confirm</a>
            </div>
