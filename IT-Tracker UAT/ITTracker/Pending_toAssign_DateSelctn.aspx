<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="Pending_toAssign_DateSelctn.aspx.cs" Inherits="ITTracker.Pending_toAssign_DateSelctn" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="js/pending_toassign.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <form id="Form1" class="form-inline row-border" action="#" runat="server">
            <div class="col-md-12 card-body" style="box-shadow:7px 7px 15px -1px;color:gray;">
            <div class="row ">
                <div class="ma-header col-5"></div>
                <div class="ma-header">
                    <h4 style="color: #45457b; align-items: center; align-content: center;margin-left:-54px;">PENDING TO ASSIGN FOR TESTING</h4>
                </div>
            </div>
             <hr />
            <div class="row col-sm-12" style="padding-bottom:20px;margin-left:33%; ">
                ...
                <div class="form-group col-sm-2" style="padding-left: 0;">
                 ...
                 <div class="row p-1" style="margin-left:33%;">
                <div class="col-md-12">
