<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="PostRelease_ReportMain.aspx.cs" Inherits="ITTracker.PostRelease_ReportMain" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <link href="StyleAutoComplete.css" rel="stylesheet" />
    <script src="AutoCompleteJS.js"></script>
    <script src="js/PostReleaseReportMain.js"></script>
    <style>
    ...
    <form id="Form1" class="form-horizontal" runat="server" method="post" enctype="multipart/form-data" action="#" style="padding-top:10px;">
        ...
        <div class="row ">
            ...
            <div class="ma-header">
                ...
                <h4 style="align-items: center; align-content: center">POST RELEASE UPDATION REPORT</h4>
