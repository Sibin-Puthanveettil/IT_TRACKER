...
namespace ITTracker
{
    public partial class TestingArtifactsUpload : System.Web.UI.Page
    {
        ...
        public string deleteDownloadFileAll(string input)
        {
            try
            {
                ...
                {
                    TestingArtifactsUpload d = new TestingArtifactsUpload();
                    d.FileDelete(file);
        ...
        public static string getFileData(string pageVal, string pageval1, string pageval2)
        {
            try
            {
                TestingArtifactsUpload f = new TestingArtifactsUpload();
        ...
        public static string UploadingFile(string ImageData, string InputData)
        {
            ...
            if (extentions.Contains(InputDataExt))
            {
                ...
                result = obj1.TrackerDocumentUpload("12", InputDataDecrypted, imgByte);
                return result;
            }
            else
            {
