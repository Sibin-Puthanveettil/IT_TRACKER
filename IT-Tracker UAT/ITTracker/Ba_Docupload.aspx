<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="Ba_Docupload.aspx.cs" Inherits="ITTracker.Ba_Docupload" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="js/baDocumentation.js"></script>
                ...
                <div class="card-body shadow" style="background: #fff;">
                    <div class="row">
                        ...
                        <div class="col-md-10 align-left">
                            <select id="ddlbaCrf" class="form-control" style="width: 100%;" name="CRF_Sel" onchange="fillCRFData()">
                    ...
                    <div class="form-group col-md-12 row" id="parallelrow">
                        ...
                        <div class="col-md-3 col-sm-2 col-xs-4">
                            <a href="#" class="btn btn-sm animated-button thar-one btn-primary" style="width: 100%; margin: 5px;"
                                onclick="return ba_DocumentUpload();" id="btnChange_Doc"><i class="fa fa-upload"></i>Upload</a>
                        </div>
