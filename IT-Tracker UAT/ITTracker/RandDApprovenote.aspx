<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="RandDApprovenote.aspx.cs" Inherits="ITTracker.RandDApprovenote" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" src="http://github.com/malsup/blockui/raw/master/jquery.blockUI.js?v2.34"></script>
     <script src="js/aes.js"></script>
       <script src="js/RandDnoteApprove.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card-body">
        <div class="row ">
                ...
                <div class="ma-header">
                    <h4 style="color: #45457b; align-items: center; align-content: center">Approvenote download</h4>
                </div>
            </div>
        <hr />
        ...
        <div class="row" id="showSubmitBtn">
            <div class="col-md-2 col-sm-2 col-xs-4">
                <a href="#" class="btn btn-block btn-outline-success btn-flat" style="width: 100%; margin: 5px;"
                    onclick="return WorkApproveDownload();" id="btnSubmit"><i class="fa fa-download"></i>&nbsp;Download</a>
            </div>
