...
namespace ITTracker
{
    public partial class PMODiscussion : System.Web.UI.Page
    {
                        ...
                        string reqmailid = dt1.Rows[0][0].ToString() + "@manappuram.com";
                            ...
                            if (NextReviewrs.Length > 0)
                            {
                                ...
                                else if (pageval2 == "4")
                                {
                                    ...
                                    subj = "CRF -: " + noteid + " - Need to edit content";
