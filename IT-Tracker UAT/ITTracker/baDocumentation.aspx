<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="baDocumentation.aspx.cs" Inherits="ITTracker.baDocumentation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        $(window).on('load', function () {
           ...
           // alert(querystring);
            $("[id*=hdRqstID]").val(querystring.split("=")[1]);
             $("[id*=hddata]").val(querystring.split("=")[2]);
                        ...
                        for (let i = 0; i < uploadedElements.length; i++) {
                            ...
                            if (fileReader && fileList && fileList.length) {
                                ...
                                fileReader.onload = function () {
                                    ...
                                    let InputData1 =  $("[id*=hdRqstID]").val() + "µ" +fileno + "µ" + extension + "µ" + fileName.replace(/[^a-zA-Z0-9._]/g, '') + "µ" + $("[id*=hdUserId]").val()+"µ"+ $("[id*=hddata]").val();
                                    ...
                                    $.ajax({
                                        ...
                                        url: "baDocumentation.aspx/UploadingFile",
        ...
        function Change_DocUpload() {
            ...
            if (querystring == '0' || querystring == '' || querystring == 'undefined' || querystring == null) {
                ...
                window.location.href = "Ba_Docupload.aspx?noteid=" + note  
            }
        ...
        function File_Load() {
            ...
            $("#tblFiles").empty();
            var filenm = "ChangeDoc_" + noteid.replace(/[^a-zA-Z0-9]/g, '') + "_";
            $.ajax({
                type: "post",
                contentType: "application/json; charset=utf-8",
                url: "baDocumentation.aspx/getFileData",
                async: false,
                data: "{pageVal:'GetbaDocs', pageval1 :'" + noteid + "', pageval2 :'" + filenm + "'}",
                dataType: "json",
                success: function (Result) {
                    Result = Result.d;
            ...
            Swal.fire({
                ...
                if (result.value == true) {
                    ...
                    $.ajax({
                        ...
                        async: false,
                        contentType: "application/json; charset=utf-8",
                        url: "baDocumentation.aspx/DeleteFileInDB",
                        data: "{pageVal:'DeletebaDocs', pageval1:'" + noteid + "',pageval2:'" + usr + "',pageval3:'" + data + "'}",
                        dataType: "json",
                        success: function (Result) {
                                                    Result = Result.d;
                                                    if (Result!="") {
                                                        ...
                                                        window.location.href = "baDocumentation.aspx?noteid=" + note ;
                                                        }
            ...
            <div class="card-body">
                ...
                <div class="col-md-3 col-sm-2 col-xs-4">
                    <a href="#" class="btn btn-sm animated-button thar-one btn-primary" style="width: 70%; margin: 5px;"
                        onclick="return YesOrNo();" id="btnOther_Doc"><i class="fa fa-upload"></i>Save</a>
                </div>
            </div>
        </form>
    </div>
