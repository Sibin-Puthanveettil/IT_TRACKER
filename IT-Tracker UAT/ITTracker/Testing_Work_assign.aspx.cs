...
namespace ITTracker
{
    public partial class Testing_Work_assign : System.Web.UI.Page
    {
        ...
        [WebMethod(EnableSession = true)]
        public static List<getDropDownData> getworkData(string pageVal)
        {
            DataSet ds;
            List<getDropDownData> getData = new List<getDropDownData>();
            ITService.ITServiceClient obj1 = new ITService.ITServiceClient();
        ...
        // checking manpowers with business hours
        //created by Yadhu-358191
        [WebMethod(EnableSession = true)]
        public static string ManPower_validation(string pageVal, string pageval1,string pageval2, string pageval3)
        {
            DataSet ds;
            string str = "";
            List<getDropDownData> getData = new List<getDropDownData>();
        ...
        [WebMethod(EnableSession = true)]
        public static string TestEmp_Deatails(string pageVal, string pageval1)
        {
            DataSet ds;
            string str = "";
            List<getDropDownData> getData = new List<getDropDownData>();
        ...
        [WebMethod(EnableSession = true)]
        public static string getmanpowerData(string pageVal, string pageval1)
       {
            DataSet ds;
            string str = "";
            ITService.ITServiceClient obj1 = new ITService.ITServiceClient();
        ...
        [WebMethod(EnableSession = true)]
        public static string TestAssignConfirm(string pageVal, string pageval1, string pageval2, string pageval3)
        {
            ...
            string noteid = notes[3].ToString();
