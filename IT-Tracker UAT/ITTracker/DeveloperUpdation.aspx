<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="DeveloperUpdation.aspx.cs" Inherits="ITTracker.DeveloperUpdation" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <div id="CrfDetailsID" style="display:none">
        ...
        <div id="Doc" class="panel-group col-md-6">
                ...
                <div id="Doc1" class="panel-group col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title align-left"><%--<a data-toggle="collapse" href="#collapse2" style="color:blue">--%>Test Cases<%--</a>--%></h3>
                        </div>
    ...
    <div class="form-group col-md-12 padding-bottom-10px" style="color:black;">                   
                 <div class="form-group">
                  <table class="table table-hover align-center " id="tabChange">
                        <tbody>   
                           ...
                           <div class="row">
            <label class="col-md-1 align-left ">Developer<span class="required text-danger">*</span> </label>
             <div class="col-md-6 align-left">
                <select class="form-control" name="Change" style="width:100%" id="wstatus" onchange="updationcheck()"></select>          
                 </div>            
           </div>         
        <div id="checkfile" style="display:none;">
            ...
            <table>
                <tr>
                  <td class="col-md-2 align-right"><label>GitHub Branch:</label></td><td><input type="text" id ="gitbranch" class="form-control"  style="width: 150px; color:maroon" required/></td>
                   <td class="col-md-2 align-right"><label>GitHub Repository:</label></td><td><input type="text" id ="gitres" class="form-control"  style="width: 150px; color:maroon" required/></td>
