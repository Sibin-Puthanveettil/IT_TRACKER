...
namespace ITTracker
{
    public partial class QA_Team_Availability_monthRpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ds = obj1.TrackerSelect("GetQATrackReport", "Tester_Rptcount", mnuId, "", "");
        ...
        protected void btn_Excel_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Tester_countReport.xls");
        ...
        public void Excel_export(DataTable dt)
        {
            ...
            Response.ContentType = "application/vnd.ms-excel";
            Response.AppendHeader("Content-Disposition", "attachment; filename=Tester_MonthcountReport.xls");
