...
namespace ITTracker
{
    public partial class TestWbs : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
          ...
          //  string mnuId = Decrypt(HttpUtility.UrlDecode(Request.QueryString["mnuId"]));
            ...
            ds = obj1.TrackerSelect("WBSREPORT", mnuId,"", "", "");
            if(ds!=null)
            {
        ...
        protected void btn_Excel_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=WBSReport.xls");
