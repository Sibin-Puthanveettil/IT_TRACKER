<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="CRFFeedbackRequest.aspx.cs" Inherits="ITTracker.CRFFeedbackRequest" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <script src="js/CRFFeedbackRequest.js" ></script>
    <style>
       ...
       <div id="CrfDetailsID" style="display:none">
             ...
             <div class="row">
               ...
               <div class="form-group">
                ...
                <input type="text" placeholder=" "id="txtlink" title="path" >
            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <label class="pure-material-textfield-outlined">
                <input type="text" placeholder=" "id="txtpath" title="path" >
                 <span>Path...</span>
                </label>
               </div>
             </div>
