...
namespace ITTracker
{
    public partial class OtherDocUpload : System.Web.UI.Page
    {
        ...
        public string deleteDownloadFileAll(string input)
        {
            try
            {
                ...
                {
                    OtherDocUpload d = new OtherDocUpload();
                    d.FileDelete(file);
        ...
        public static string getFileData(string pageVal, string pageval1, string pageval2)
        {
            try
            {
                OtherDocUpload f = new OtherDocUpload();
        ...
        public static string UploadingFile(string ImageData, string InputData)
        {
            ...
            if (extentions.Contains(InputDataExt))
            {
                ...
                result = obj1.TrackerDocumentUpload("13", InputDataDecrypted, imgByte);
                return result;
            }
            else
            {
