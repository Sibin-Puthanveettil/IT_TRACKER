...
namespace ITTracker
{
    public partial class CRFStatusReport : System.Web.UI.Page
    {
        ...
        public static string UserDeptCheck(string pageVal,string pageval1)
        {
            string result = "";
            ...
            try
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (result == "0") result = "999";//not md tech
                    else result = "666";
                }
                else result = "999";//not md tech
            }
            catch (Exception e)
            {
