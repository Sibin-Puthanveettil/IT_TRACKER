...
namespace ITTracker
{
    public partial class Searchresultba_dashbrd : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           // string usrid = Convert.ToString(HttpContext.Current.Session["username"]);


            ds = obj1.TrackerSelect("bareportdash", mnuId, Convert.ToString(HttpContext.Current.Session["username"]),s, "");
