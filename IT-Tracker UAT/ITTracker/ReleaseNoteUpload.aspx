<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="ReleaseNoteUpload.aspx.cs" Inherits="ITTracker.ReleaseNoteUpload" %>
                            ...
                            if (fileReader && fileList && fileList.length) {
                                ...
                                fileReader.onload = function () {
                                    ...
                                    $.ajax({
                                        ...
                                        url: "ReleaseNoteUpload.aspx/UploadingFile",
...
function Change_DocUpload() {
    ...
    var noteid = $("[id*=hdRqstID]").val();
            ...
            $.ajax({
                type: "post",
                contentType: "application/json; charset=utf-8",
                url: "ReleaseNoteUpload.aspx/getFileData",
                async: false,
                data: "{pageVal:'GetReleasDoc', pageval1 :'" + noteid+ "', pageval2 :'" + filenm + "'}",
                dataType: "json",
                success: function (Result) {
                    Result = Result.d;
            ...
            Swal.fire({
                    ...
                    if (result.value == true) {
                        ...
                        $.ajax({
                                type: "post",
                                contentType: "application/json; charset=utf-8",
                                url: "ReleaseNoteUpload.aspx/DeleteFileInDB",
                                ...
                                success: function (Result) {
                                                    ...
                                                    if (Result!="") {
                                                        ...
                                                        window.location.href = "ReleaseNoteUpload.aspx?noteid=" + note + "=" + reqid+"="+module
                                                        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="card card-5 rightmarg">
        <form class="form-inline" runat="server" method="post" enctype="multipart/form-data">
            <div class="card-body">
                <h2> Attach Release Note/Document</h2>
            ...
            <div class="file-uploader__message-area">
                ...
                <div class="col-md-3 col-sm-2 col-xs-4">
                    <a href="#" class="btn btn-sm animated-button thar-one btn-primary" style="width: 70%; margin: 5px;"
                        onclick="return YesOrNo();" id="btnRelease_Doc"><i class="fa fa-upload"></i>Save</a>
                </div>
            </div>
      </form>
  </div>
