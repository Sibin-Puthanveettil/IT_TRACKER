...
namespace ITTacker
{
    public partial class NoteApprovedView : System.Web.UI.Page
    {
        string _paraBreak = "\r\n\r\n";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
              ...
              //  note= qrystr.Split('-');
                ...
                datasetStatus = obj1.PwaSelectData("PWAAPP", "GetApprovedStatus", noteid, "", "");
                ...
                if (statuscnt>0)
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("RdlcNoteApproved.rdlc");
                    ...
                    string str = "";
                    string flag = "9";
                    datasetContent = obj1.PwaSelectData("PWAAPP", "GetRequestNotes", noteid, "", "");
                   ...
                   // string username = "John K Thomas";
                    ...
                    datasetApprovers = obj1.PwaSelectData("PWAAPP", "GetApprovedRDLC", noteid, "", "");
                    datasetHeader = obj1.PwaSelectData("PWAAPP", "GetApprovedRDLCheader", noteid, "", "");
                    datasetFooter = obj1.PwaSelectData("PWAAPP", "GetApprovedRDLCfooter", noteid, "", "");
                    datasetImgStat = obj1.PwaSelectData("PWAAPP", "GetNoteStatus", noteid, "", "");
                    if(Convert.ToInt32(datasetImgStat.Tables[0].Rows[0][0])==9)
                    {
                        flag = "9";
                    }
                    if (Convert.ToInt32(datasetImgStat.Tables[0].Rows[0][0]) == 0)
                    {
                        flag = "0";
                    }
                    if (Convert.ToInt32(datasetImgStat.Tables[0].Rows[0][0]) == 7)
                    {
                        flag = "7";
                    }
                    ...
                    ReportParameterCollection.Add(new ReportParameter("NoteContent", str));
                    ...
                    ReportParameterCollection.Add(new ReportParameter("apprej", flag));
                    ReportParameterCollection.Add(new ReportParameter("note", noteid));
