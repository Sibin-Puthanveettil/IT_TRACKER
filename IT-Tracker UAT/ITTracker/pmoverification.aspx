<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="pmoverification.aspx.cs" Inherits="ITTracker.pmoverification" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <%-- <link rel="stylesheet" href="css/jquery.datetimepicker.min.css">
   <script src="//code.jquery.com/jquery.min.js"></script>
	<script src="js/jquery.datetimepicker.js"></script>--%>
    <script src="js/PMOVerify.js" + "new Date().getTime()"></script>
    <style>
        /*label {
            display: block;
        ...
        <form class="form-inline" runat="server" method="post" enctype="multipart/form-data">
             ...
             <div class="col-md-10 align-left">
               <select id="ddlCrf" class="form-control" style="width:100%;" name="CRF_Sel" onchange="fillCRFData()">
                ...
                <div class="form-group col-md-12 padding-bottom-10px" style="color: black;">
                    <label class=" col-md-2 align-right">Tech Analyst : </label>
                    <div class="col-md-3 align-left">
                        <select class="form-control input-group-text" id="techlead" style="width: 100%;" name="techlead" onchange="techleadfill()">
                                <option value="-1">Select Tech Analyst</option>
                        </select>
                    </div> 
                     <label class=" col-md-2 align-right">Related Module : </label>
                       <div class="col-md-3 align-left"> 
                           <select class="form-control input-group-text" id="exmodule" style="width:100%;" name="techlead" ">
                ...
                <hr/>
           <%--     <div class="form-group col-md-12 padding-bottom-10px p-1" style="color: black;">     
                 <div class="form-group col-md-4 padding-bottom-10px" style="color:black;">   --%>                
           ...
           <%--      </div>                           
                ...
                <div class="form-group col-md-12 padding-bottom-10px" style="color: black;">
                    ...
                    <label class=" col-md-2 align-right">Need Discussion : </label>
                    <div class="col-md-2 align-left ">
                        <input type="radio" name="rbReturn" id="rbReturn"  onclick="ShowPurpose()" /><span style="color: blue"> YES &nbsp;&nbsp;&nbsp;&nbsp; </span>                            
                         <input type="radio" name="rbReturn" id="rbNonReturn"  onclick="ShowPurpose1()" /><span style="color: blue"> NO</span>
                    </div>
                    
                </div>
                <div id="rtnDate" class="form-group row col-md-12 padding-bottom-10px" style="color: black;display: none">
                    <div class="col-md-4 align-left">
                    <input type="text" placeholder="Date..." class="form-control"  style="width:100%" id="txtDate" name="txtDate"/>                 
                    </div>                 
                    <label class="col-md-2" for="appt">Your Meeting Time</label> 
                ...
                <div id="demo"></div>
                <div class="row col-md-12" id="showSubmitBtn">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-4">
                        <a href="#" class="btn btn-sm animated-button thar-one btn-red" style="width: 100%; margin: 5px;"
                            onclick="return RejectNote();" id="btnReject"><i class="fa fa-thumbs-down"></i>Reject</a>
                    </div>
                    <div class="col-md-2 col-sm-2 col-xs-4">
