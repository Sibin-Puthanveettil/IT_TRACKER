<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="AdminNoteChanges.aspx.cs" Inherits="ITTacker.AdminNoteChanges" %>
...
function GetEmpList(noteid) {
     $("#ddlEmp").empty();
    var QueryString = "GetEmpList";
        $.ajax({
            type: "post",
            contentType: "application/json; charset=utf-8",
            url: "Approve2.aspx/getFillData",
            data: "{pageVal:'GetEmpList', pageval1 :'" + noteid + "', pageval2 :''}",
            dataType: "json",
            success: function (Result) {
                Result = Result.d;
...
function NoteRecommendConfirm() {
    ...
    var empdata = "";
    if (recStatus == 4 || recStatus == 5|| recStatus == 10 || recStatus == 15) {
   ...
   // debugger;
    ...
    $.ajax({
        ...
        data: "{pageVal:'ConfirmRecommendNote', pageval1 :'" + Data + "',pageval2:'"+ noteid +"',pageval3:''}",
        dataType: "json",
        async: false,
        success: function (Result) {
          Result = Result.d;
