...
namespace ITTracker
{
    public partial class DailyReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if(mnuId.Contains("CRFWISE"))
            {
                ds = obj1.TrackerSelect("DAILYREPORTVIEW", "CRFWISE", mnuId, "", "");
            }
            else if (mnuId.Contains("TMWISE"))
            {
                ds = obj1.TrackerSelect("DAILYREPORTVIEW", "TMWISE", mnuId, "", "");
            }
             else if (mnuId.Contains("CRF-WISEQA"))
            {
                ds = obj1.TrackerSelect("DAILYREPORTVIEW", "CRFWISEQA", mnuId, "", "");
            }
            else if (mnuId.Contains("Pnjblkchk"))
            {
                ds = obj1.TrackerSelect("DAILYREPORTVIEW", "Pnjblkchk", mnuId, "", "");
            }
        ...
        //public string saveInputData(string pageval)
        //{
