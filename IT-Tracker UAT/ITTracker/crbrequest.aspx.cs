...
namespace ITTracker
{
    public partial class crbrequest : System.Web.UI.Page
    {
        ...
        public static string getEditDataFxd(string pageVal,string pageval1, string pageval2)
        {
            DataSet ds;
            string str = "";
            int i = 0;
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    str = str + ds.Tables[0].Rows[i][0].ToString() + "^" + ds.Tables[0].Rows[i][1].ToString() +"^"+ ds.Tables[0].Rows[i][2].ToString() + "^" + ds.Tables[0].Rows[i][3].ToString()+ "^" + ds.Tables[0].Rows[i][4].ToString() + "^" + ds.Tables[0].Rows[i][5].ToString() + "^" + ds.Tables[0].Rows[i][6].ToString() + "§";
                    i++;
                }
                return str;
            }
        ...
        [WebMethod(EnableSession = true)]
        public static string CRBRequestConfirm(string pageVal, string pageval1, string pageval2, string pageval3)
        {
            ...
            try
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    try
                    {
                        ...
                        dt1 = obj1.TrackerSelect("CRBEmailRequest", str, "", "", "").Tables[0];
                        string reqmailid = dt1.Rows[0][0].ToString();
                        

                        dt2 = obj1.TrackerSelect("CRBEmailReviewNext", str, "", "", "").Tables[0];
                        string NextReviewrsId = dt2.Rows[0][0].ToString();
                        string NextReviewrsName = dt2.Rows[0][1].ToString();

                        dt3 = obj1.TrackerSelect("CRBRDLCheader", str, "", "", "").Tables[0];
