...
namespace ITTracker
{
    public partial class CRFFeedbackRequest : System.Web.UI.Page
    {
        ...
        [WebMethod(EnableSession = true)]
        public static string RequestConfirm(string pageVal, string pageval1, string pageval2, string pageval3)
        {
            DataSet ds, ds1, ds2, ds3;
            string str = "", newcontent = "";
            ITService.ITServiceClient obj1 = new ITService.ITServiceClient();
            ds = obj1.TrackerSelect("USERFEEDBACK",pageVal, pageval1, pageval2, pageval3);
